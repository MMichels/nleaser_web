...
export const CardMetodos = () => {
    ...
    return (
        <Col className={`${styles.cardMetodos} p-2 py-5 h-100`}>            
                    ...
                    Metodos.map(metodo => {
                        return (
                            <Container className={`bg-white bg-opacity-75 text-black text-center p-0 p-sm-1 p-md-2 pb-sm-2 pb-md-3`}>
                                <Container className="d-flex justify-content-center bg-secondary bg-opacity-75 bg-gradient text-white p-2 p-md-0">
                                    <h2>
                                        {metodo.title}
                                    </h2>
                                    <div className="d-block d-md-none" style={{ zIndex: 10}}>
                                        ...
                                        >
                                            <button className="mx-1 text-white" style={{backgroundColor: "transparent", border: "none"}}>
                                                <FontAwesomeIcon size="lg" fixedWidth={false} icon={faQuestionCircle} />
                                            </button>
